(function (app) {
    ...
    app.controller('movies2Ctrl', movies2Ctrl);

    movies2Ctrl.$inject = ['$scope', 'apiService', 'notificationService'];

    function movies2Ctrl($scope, apiService, notificationService) {
