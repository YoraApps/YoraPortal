(function (app) {
    ...
    app.controller('movies1Ctrl', movies1Ctrl);

    movies1Ctrl.$inject = ['$scope', 'apiService', 'notificationService'];

    function movies1Ctrl($scope, apiService, notificationService) {
